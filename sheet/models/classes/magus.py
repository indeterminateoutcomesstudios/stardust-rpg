...
ice_slick_1 = Ability(
    ...
    shape=Shape.circle, target_area='2RAD', duration='4', duration_unit=DurationUnit.rnd,
...
ice_slick_2 = Ability(
    ...
    shape=Shape.circle, target_area='2RAD', duration='6', duration_unit=DurationUnit.rnd,
    effect='Creates a slippery patch of ice.  Enemies who fail MDEF are immobilized for 1RND',
...
ice_slick_3 = Ability(
    ...
    damage_type=DamageType.cold, targets_mdef=True, max_range='7',
    shape=Shape.circle, target_area='[[2+WIS]]RAD', duration='6', duration_unit=DurationUnit.rnd,
    effect='Creates a slippery patch of ice.  Enemies who fail MDEF are immobilized for 1RND',
