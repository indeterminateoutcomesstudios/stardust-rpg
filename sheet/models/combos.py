...
class Combo(Ability):
    def __init__(self, classes: Tuple[Class, Class], prerequisite_lvl: int,
                 name: str, mp_cost: int, target_area: str, duration: str = None,
        ...
        super().__init__(name=name, mp_cost=mp_cost, target_area=target_area, duration=duration,
                         duration_unit=duration_unit, prerequisites=(),
...
combos = (
    Combo(
        ...
        name='Temporal Shock Wave I', mp_cost=4, attacks=1, mdam='d10 + WIS',
    ...
    Combo(
        ...
        name='Temporal Shock Wave II', mp_cost=7, attacks=1, mdam='2d12 + WIS',
        damage_type=DamageType.force, targets_mdef=True, time=Time.full_a, min_range=1,
    ...
    Combo(
        ...
        name='Temporal Shock Wave III', mp_cost=12, attacks=1, mdam='4d12 + 2*WIS',
        damage_type=DamageType.force, targets_mdef=True, time=Time.full_a, min_range=1,
